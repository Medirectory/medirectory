class AddLatitudeLongitudeToEntities < ActiveRecord::Migration
  def up
    add_column :providers, :practice_location_address_latitude, :decimal, precision: 15, scale: 10
    add_column :providers, :practice_location_address_longitude, :decimal, precision: 15, scale: 10
    execute %{
      CREATE INDEX on providers USING gist(ll_to_earth(practice_location_address_latitude, practice_location_address_longitude));
    }
    add_column :organizations, :practice_location_address_latitude, :decimal, precision: 15, scale: 10
    add_column :organizations, :practice_location_address_longitude, :decimal, precision: 15, scale: 10
    execute %{
