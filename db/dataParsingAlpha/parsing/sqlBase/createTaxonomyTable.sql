...
SELECT 
  ...
  ]) as healthcare_provider_taxonomy_code,
  unnest(array[
  ...
  ]) as provider_license_number_state_code,
  unnest(array[
  ...
  ]) as healthcare_provider_primary_taxonomy_switch,
  npi
FROM nppes
GROUP BY healthcare_provider_taxonomy_code, 
  provider_license_number, 
  provider_license_number_state_code,
  healthcare_provider_primary_taxonomy_switch,
  npi
