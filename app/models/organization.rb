...
class Organization < ActiveRecord::Base
  ...
  extend Searchable(:organization_name_legal_business_name, :other_organization_name, :authorized_official_last_name, :authorized_official_first_name,
                    :authorized_official_middle_name, :authorized_official_telephone_number)
