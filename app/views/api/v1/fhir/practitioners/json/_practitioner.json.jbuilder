...
json.address do
  json.partial! 'api/v1/fhir/practitioners/json/address.json.jbuilder', locals: { address: provider.practice_location_address}
end
...
json.organization do
  json.partial! 'api/v1/fhir/practitioners/json/resource.json.jbuilder', 
...
json.period do
  if provider.npi_reactivation_date
    json.partial! 'api/v1/fhir/practitioners/json/period.json.jbuilder', 
