xml.Practitioner(xmlns:"http://hl7.org/fhir") do
  ...
  xml.address do
    xml << render(partial: 'api/v1/fhir/practitioners/xml/address.xml.builder', locals: {address: provider.practice_location_address})
  end
  ...
  xml.organization do
    xml << render(partial: 'api/v1/fhir/practitioners/xml/resource.xml.builder', 
  ...
  xml.period do
    if provider.npi_reactivation_date
      xml << render(partial: 'api/v1/fhir/practitioners/xml/period.xml.builder', 
